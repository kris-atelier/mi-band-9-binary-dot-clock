...
- 숫자, 영문, 날짜, 심박, 걸음 수, 날씨 아이콘·문자를 표시하지 않습니다. 날씨와 온도는 색으로만 구분합니다.
...
- 시간 비트(시·분)는 날씨와 관계없이 항상 흰색으로 표시합니다.
...
날씨 정보는 시간 영역의 AM/PM 점에만 색으로 표시하고, 별도의 아이콘이나 텍스트는 표시하지 않습니다. 시·분 비트는 항상 흰색이며, 우천 시에는 AM/PM 점만 파란색(`#248BFF`)으로 표시합니다.

| 정보 | 표시 위치 | 색상 |
| --- | --- | --- |
| 맑음 | AM/PM 점 | 노랑 `#FFD43B` |
| 흐림·구름 | AM/PM 점 | 회색 `#777777` |
| 비·소나기 | AM/PM 점 | 파랑 `#248BFF` |
| 눈 | AM/PM 점 | 연한 하늘색 `#BFE8FF` |
| 뇌우·번개 | AM/PM 점 | 보라 `#8A5CFF` |

현재 온도는 초 틱의 색으로 표시합니다.
...
충전 필요 상태(배터리 20% 이하)에서는 날씨 색상보다 빨간색 충전 경고를 우선합니다.
...
- `assets/preview-weather-rain-18c-180.png`: 우천·18°C 색상 표시가 적용된 180° 미리보기
...
날씨와 온도 미리보기는 다음처럼 확인할 수 있습니다.

```text
src/preview.html?weather=rain&temp=18
```
